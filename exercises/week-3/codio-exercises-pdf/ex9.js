...
// The Exercise
// 1. Declare a variable 'numSiblings' based on a prompt input like this: prompt('How many siblings do you have?');
...
function logNumberOfSiblings(numSiblings) {
...
logNumberOfSiblings(numSiblings);