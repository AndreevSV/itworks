...
const bulbasaur = new Pokemon('Bulbasaur', 'grass', ['Tackle', 'Vine Whip', 'Take Down', 'Power Whip']);
const pikachu = new Pokemon('Pikachu', 'electric', ['Nuzzle', 'Quick Attack', 'Feint', 'Spark', 'Iron Tail']);
const charizard = new Pokemon('Charizard', 'fire', ['Dragon Claw', 'Sratch', 'Fire Fang', 'Slash', 'Flare Blitz']);
